...
const file_proto_event_proto_rawDesc = "" +
	"\n" +
	"\x11proto/event.proto\x12\x05event\"\xb8\x02\n" +
	"\x05Event\x12\x0e\n" +
	...
	"\x06images\x18\v \x03(\tR\x06images\"\xf1\x01\n" +
...
func file_proto_event_proto_init() {
	...
	file_proto_event_proto_msgTypes[5].OneofWrappers = []any{}
	file_proto_event_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
