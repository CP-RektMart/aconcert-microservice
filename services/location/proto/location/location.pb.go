...
func (x *UpdateZoneRequest) GetLocationId() string {
	if x != nil {
		return x.LocationId
	}
	return ""
...
const file_location_proto_rawDesc = "" +
	"\n" +
	"\x0elocation.proto\x12\blocation\"\xee\x01\n" +
	"\bLocation\x12\x0e\n" +
	...
	"zoneNumber\"X\n" +
	"\x11UpdateZoneRequest\x12\x1f\n" +
	"\vlocation_id\x18\x01 \x01(\tR\n" +
	"locationId\x12\"\n" +
	"\x04zone\x18\x02 \x01(\v2\x0e.location.ZoneR\x04zone2\x9a\x04\n" +
	...
	"\n" +
	"RemoveZone\x12\x1b.location.RemoveZoneRequest\x1a\x1c.location.LocationIdResponseB\x14Z\x12/location;locationb\x06proto3"
...
var file_location_proto_goTypes = []any{
	...
	(*UpdateZoneRequest)(nil),      // 11: location.UpdateZoneRequest
}
var file_location_proto_depIdxs = []int32{
	...
	1,  // 4: location.UpdateZoneRequest.zone:type_name -> location.Zone
	0,  // 5: location.LocationService.CreateLocation:input_type -> location.Location
	3,  // 6: location.LocationService.GetLocation:input_type -> location.GetLocationRequest
	4,  // 7: location.LocationService.ListLocations:input_type -> location.ListLocationsRequest
	6,  // 8: location.LocationService.UpdateLocation:input_type -> location.UpdateLocationRequest
	7,  // 9: location.LocationService.DeleteLocation:input_type -> location.DeleteLocationRequest
	9,  // 10: location.LocationService.AddZone:input_type -> location.AddZoneRequest
	10, // 11: location.LocationService.RemoveZone:input_type -> location.RemoveZoneRequest
	2,  // 12: location.LocationService.CreateLocation:output_type -> location.LocationIdResponse
	0,  // 13: location.LocationService.GetLocation:output_type -> location.Location
	5,  // 14: location.LocationService.ListLocations:output_type -> location.ListLocationsResponse
	2,  // 15: location.LocationService.UpdateLocation:output_type -> location.LocationIdResponse
	8,  // 16: location.LocationService.DeleteLocation:output_type -> location.DeleteLocationResponse
	2,  // 17: location.LocationService.AddZone:output_type -> location.LocationIdResponse
	2,  // 18: location.LocationService.RemoveZone:output_type -> location.LocationIdResponse
